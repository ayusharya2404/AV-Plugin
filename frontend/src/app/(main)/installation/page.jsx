      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="space-y-6">
          ...
          <div className="text-center space-y-4 mb-12">
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent animate-pulse">
          ...
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-700 hover:border-gray-600 transition-all duration-300">
            ...
            <div className="mt-8">
              ...
              <p className="text-gray-400 mb-4">
                Add the plugin to your <code className="text-purple-300 bg-gray-950 px-1 py-0.5 rounded">tailwind.config.js</code> file:
              </p>
              <div className="relative">
                <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto font-mono text-sm">
          ...
          {/* Next Steps Card */}
          <div className="bg-gradient-to-r from-blue-900/40 to-purple-900/40 rounded-lg p-6 border border-blue-800/50 mt-12">
            ...
            <div className="mt-6">
              <button className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200 transform hover:scale-105">
                View Documentation
              </button>
            </div>
          </div>
