...
const ManageUser = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-black md:flex-row">
      {/* Mobile Header */}
      <div className="flex items-center justify-between p-4 bg-neutral-900 shadow-md md:hidden">
        <button 
          onClick={() => setSidebarOpen(!sidebarOpen)}
          className="p-2 text-gray-400 rounded-md hover:bg-neutral-800"
        >
          {sidebarOpen ? <X className="w-6 h-6" /> : <Menu className="w-6 h-6" />}
        </button>
        <h1 className="text-xl font-semibold text-white">User Admin</h1>
        <div className="flex items-center space-x-2">
          <button className="p-2 text-gray-400 rounded-full hover:bg-neutral-800">
      ...
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'block' : 'hidden'} w-full md:block md:w-64 bg-neutral-900 shadow-md flex-shrink-0 fixed md:relative inset-0 z-10 md:z-0 md:h-screen overflow-y-auto`}>
        <div className="p-4 border-b border-neutral-800">
          <h1 className="text-xl font-semibold text-white">User Admin</h1>
        </div>
        <div className="p-4">
          <nav className="space-y-2">
            <a href="#" className="flex items-center p-2 text-white bg-neutral-800 rounded-md hover:bg-neutral-700">
              <Users className="w-5 h-5 mr-3 text-gray-400" />
              <span>Users</span>
            </a>
            <a href="#" className="flex items-center p-2 text-gray-400 rounded-md hover:bg-neutral-800">
      ...
      <div className="flex-1 overflow-auto">
        {/* Desktop Top Bar */}
        <div className="hidden items-center justify-between p-4 bg-neutral-900 shadow-md md:flex">
          <div className="flex items-center px-2 py-1 bg-neutral-800 rounded-md w-64">
        ...
        <div className="p-4 md:hidden">
          <div className="flex items-center px-2 py-2 bg-neutral-800 rounded-md">
        ...
        <div className="p-4 md:p-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            ...
            <button 
              className="flex items-center justify-center px-4 py-2 text-white bg-neutral-700 rounded-md hover:bg-neutral-600"
          ...
          <div className="flex flex-col md:flex-row md:items-center mb-6 space-y-3 md:space-y-0 md:space-x-4">
            <div className="flex items-center">
              ...
              <select 
                className="px-2 py-1 text-sm bg-neutral-800 text-gray-300 border border-neutral-700 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-500"
                value={roleFilter}
            ...
            <div className="md:ml-auto">
              <button 
                className={`px-3 py-1 text-sm rounded-md ${
                  selectedUsers.length > 0 ? 'bg-neutral-700 text-white hover:bg-neutral-600' : 'bg-neutral-800 text-gray-400 cursor-not-allowed'
                }`}
          ...
          {/* Users Table - Desktop */}
          <div className="hidden md:block overflow-hidden bg-neutral-900 rounded-lg shadow-md">
                ...
                <tr>
                  <th className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-400 uppercase">
                    <div className="flex items-center">
                      <input
                        type="checkbox"
                        className="w-4 h-4 text-gray-600 bg-neutral-700 border-neutral-700 rounded focus:ring-gray-500"
          ...
          <div className="md:hidden space-y-4">
            {filteredUsers.map(user => (
              <div key={user.id} className="bg-neutral-900 rounded-lg shadow-md p-4">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    <input
                      type="checkbox"
                      className="w-4 h-4 text-gray-600 bg-neutral-700 border-neutral-700 rounded focus:ring-gray-500 mr-3"
                      checked={selectedUsers.includes(user.id)}
                      onChange={() => toggleSelectUser(user.id)}
                    />
                    <img
                ...
                <div className="flex justify-end space-x-2">
                  <button 
                    className="p-2 text-gray-400 hover:text-gray-300 hover:bg-neutral-800 rounded-md"
                    onClick={() => handleAvPluginAction('edit', user.id)}
                  >
                    <Edit className="w-4 h-4" />
                  </button>
          ...
          <div className="flex items-center justify-between py-3 mt-4">
            <div className="flex justify-between flex-1 sm:hidden">
              <button className="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-400 bg-neutral-800 border border-neutral-700 rounded-md hover:bg-neutral-700">
                Previous
              </button>
              <button className="relative inline-flex items-center px-4 py-2 ml-3 text-sm font-medium text-gray-400 bg-neutral-800 border border-neutral-700 rounded-md hover:bg-neutral-700">
                Next
              </button>
            </div>
            <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
              ...
              <div>
                <nav className="inline-flex -space-x-px rounded-md shadow-sm isolate" aria-label="Pagination">
                  <button className="relative inline-flex items-center px-2 py-2 text-gray-400 rounded-l-md ring-1 ring-inset ring-neutral-700 hover:bg-neutral-800 focus:outline-offset-0">
                    <span className="sr-only">Previous</span>
                    <ChevronDown className="w-5 h-5 rotate-90" />
                  </button>
                  <button className="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-white bg-neutral-700 focus:outline-offset-0">
                    1
                  </button>
                  <button className="relative inline-flex items-center px-2 py-2 text-gray-400 rounded-r-md ring-1 ring-inset ring-neutral-700 hover:bg-neutral-800 focus:outline-offset-0">
